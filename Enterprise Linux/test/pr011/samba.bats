...
admin_user=matthias            #er with admin privileges
admin_password=matthias
...
@test "check group wr acc on files" {
  ...
  assert_group_write_file directie matthias  matthias  maaiked maaiked
  assert_group_write_file financieringen matthias  matthias  maaiked maaiked
  assert_group_write_file staf matthias  matthias  maaiked maaiked
  assert_group_write_file verzekeringen matthias  matthias  maaiked maaiked
  assert_group_write_file publiek matthias  matthias  maaiked maaiked
  assert_group_write_file beheer matthias  matthias  maaiked maaiked
  assert_group_write_file verzekeringen matthias  matthias  maaiked maaiked
}

@test "check group write acces on directies" {
   #                      Share    Usr1 Pwd1 user2   passwd2
  assert_group_write_dir directie matthias  matthias  maaiked maaiked
  assert_group_write_dir financieringen matthias  matthias  maaiked maaiked
  assert_group_write_dir staf matthias  matthias  maaiked maaiked
  assert_group_write_dir verzekeringen matthias  matthias  maaiked maaiked
  assert_group_write_dir publiek matthias  matthias  maaiked maaiked
  assert_group_write_dir beheer matthias  matthias  maaiked maaiked
  assert_group_write_dir verzekeringen matthias  matthias  maaiked maaiked
}