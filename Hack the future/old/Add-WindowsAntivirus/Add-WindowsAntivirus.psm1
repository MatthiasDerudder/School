...
function Add-WindowsAntivirus
{
    ...
    $config_string = '{"AntimalwareEnabled" : true}'    Get-AzureVM -ServiceName $Servicename -Name $VirtualMachineName| Set-AzureVMMicrosoftAntimalwareExtension -AntimalwareConfiguration $config_string -Monitoring ON -StorageContext $StorageContext | Update-AzureVM
    }
    End
    {
    }
